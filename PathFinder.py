...
class PathFinder():
    ...
    def BFS(self, source, objectives, childs, first=True, max_cost=10):
        """ Find closest objective to source using BFS, with a max lenght path of max_cost"""
    ...
    def BFSr(self, source, objectives, childs, first=True, max_cost=10, backward=False):
        """ Find closest source to objective using BFS, with a max lenght path of max_cost"""
        tree = Node(source, None, 0)
        visited = set()
        cost = 0
        founds = []
